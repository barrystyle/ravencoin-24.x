...
public:
    CMainParams() {
        ...
        consensus.kawLimit = uint256S("0000000000ffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        ...
        vSeeds.emplace_back("seed-raven.bitactivate.com.");
        vSeeds.emplace_back("seed-raven.ravencoin.com.");
        vSeeds.emplace_back("seed-raven.ravencoin.org.");
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        consensus.kawLimit = uint256S("000000ffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        consensus.nPowTargetTimespan = 2016 * 60; // 1.4 days
        consensus.nPowTargetSpacing = 1 * 60;
        ...
        genesis = CreateGenesisBlock(1537466400, 15615880, 0x1e00ffff, 2, 5000 * COIN);
        consensus.hashGenesisBlock = genesis.GetGenesisHash();
        ...
        vSeeds.emplace_back("seed-testnet-raven.bitactivate.com.");
        vSeeds.emplace_back("seed-testnet-raven.ravencoin.com.");
        vSeeds.emplace_back("seed-testnet-raven.ravencoin.org.");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.kawLimit = uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        consensus.nPowTargetTimespan = 2016 * 60; // 1.4 days
        consensus.nPowTargetSpacing = 1 * 60;
